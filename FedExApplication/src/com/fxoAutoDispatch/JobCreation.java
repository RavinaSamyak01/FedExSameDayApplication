...
public class JobCreation extends BaseInit {
	static StringBuilder msg = new StringBuilder();

	@Test
	public static void jobCreation() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, 50);
		// Read data from Excel
		File src = new File(".\\src\\TestFiles\\FXOAutoDispatch.xlsx");
		...
		for (int i = 1; i < 6; i++) {
			...
			File src1 = new File(
					"C:\\Abhishek\\ABHISHEK SHARMA\\workspace\\FedExApplication\\src\\TestFiles\\FXOAutoDispatch.xlsx");
		...
		String subject = "STAGING : FXO-Auto Dispatch Shipment Creation Using SELENIUM";
		try {
			Email.sendMail("asharma@samyak.com", subject, msg.toString(), "");
		} catch (Exception ex) {
			Logger.getLogger(JobCreation.class.getName()).log(Level.SEVERE, null, ex);
		}
